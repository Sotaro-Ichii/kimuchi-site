  ...
  return (
    <div style={{ backgroundColor: '#f1f5f9', minHeight: '100vh', padding: '30px', fontFamily: 'sans-serif', color: '#1e293b' }}>
      ...
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ color: '#2563eb', fontSize: '1.5rem', marginBottom: '15px', fontWeight: 'bold' }}>利用規約</h2>
        <p>
      ...
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ color: '#2563eb', fontSize: '1.5rem', marginBottom: '15px', fontWeight: 'bold' }}>免責事項</h2>
        <p>
      ...
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ color: '#2563eb', fontSize: '1.5rem', marginBottom: '15px', fontWeight: 'bold' }}>プライバシーポリシー</h2>
        <p>
      ...
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ color: '#2563eb', fontSize: '1.5rem', marginBottom: '15px', fontWeight: 'bold' }}>無断模倣に関する注意事項</h2>
        <p>
      ...
      <section>
        <h2 style={{ color: '#2563eb', fontSize: '1.5rem', marginBottom: '15px', fontWeight: 'bold' }}>お問い合わせ</h2>
        <p>
